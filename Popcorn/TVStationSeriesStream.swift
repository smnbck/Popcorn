...
class TVStationSeriesStream: SeriesStream {
    var stationId: Int
    ...
    init(id: Int, title: String, description: String, seasons: [Season], genre: String?, usk: String?, rating: String?, stationId: Int, tvStationName: String, startingTime: String, endingTime: String, nextShow: String, isExistingShow: Bool) {
